...
class TestCase(BaseTestCase):
    def test_yeni_donem_olusturma(self):
        ...
        baslangictaki_donem_sayisi = Donem.objects.count()
        onceki_donem_keyleri = [d.key for d in Donem.objects.all()]
        ...
        sonraki_donem_keyleri = [d.key for d in Donem.objects.all()]
