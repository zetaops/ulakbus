...
from ulakbus.models import User, Sinav, OgrenciDersi, DegerlendirmeNot
...
class TestCase(BaseTestCase):
    ...
    def test_ogrenci_not_duzenleme(self):
        ...
        resp = self.client.post(
            form={'ileri': 1, 'sube': "I8BhWGKroZIp3fp5b26ZtZJTULO", 'form_key': "0dff6463b28843f1aa50c6a2361ee1df"})
