...
class TestCase(BaseTestCase):
    """
    BAP satın alma duyurularının listelenmesini ve duyurulara ait işlemlerin gerçekleştirilmesini sağlayan iş akışı testi. İş akışının doğru çalışması için her çalıştırıldığında BAPProje modeli resetlenmeli ve bap_proje.csv yeniden yüklenmelidir.
