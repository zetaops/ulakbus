...
class TestCase(BaseTestCase):
    ...
    def test_ogrencileri_odalara_dagitma(self):
        ...
        # ogrenciler = sinav_etkinligi.sinav_ogrenci_listesi()
        # for ogrenci in ogrenciler:
        #     sinav_etkinligi.Ogrenciler(ogrenci = ogrenci)
        #     sinav_etkinligi.save()

        assert len(sinav_etkinligi.Ogrenciler) == OgrenciDersi.objects.filter(sube = sinav_etkinligi.sube,
                                                                              donem = sinav_etkinligi.donem).count()
        ...
        for etkinlik in sinav_etkinligi.Ogrenciler:
            ...
            if etkinlik.room.code in sinav_yerleri:
