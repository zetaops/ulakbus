...
class AbsRole(Enum):
    ...
    YUKSELOKUL_KURULU_BASKANI = __(u"Yüksekokul Kurulu Başkanı")
    YUKSELOKUL_YONETIM_KURULU_BASKANI = __(u"Yüksekokul Yönetim Kurulu Başkanı")
    YUKSELOKUL_BIRIM_KOORDINATORU = __(u"Yüksekokul Birim Koordinatörü")
    YUKSELOKUL_YONETIM_KURULU_UYESI = __(u"Yüksekokul Yönetim Kurulu Üyesi")
    YUKSELOKUL_MUDURU = __(u"Yüksekokul Müdürü")
    YUKSELOKUL_MUDUR_YARDIMCISI = __(u"Yüksekokul Müdür Yardımcısı")
    YUKSELOKUL_SEKRETERI = __(u"Yüksekokul Sekreteri")
    YUKSELOKUL_OGRENCI_ISLERI_SEFI = __(u"Yüksekokul Öğrenci İşleri Şefi")
    YUKSELOKUL_KURULU_UYESI = __(u"Yüksekokul Kurulu Üyesi")
    YUKSELOKUL_MUHASEBE_ISLERI_SEFI = __(u"Yüksekokul Muhasebe İşleri Şefi")
    YUKSELOKUL_MUHASEBE_ISLERI_PERSONELI = __(u"Yüksekokul Muhasebe İşleri Personeli")
    YUKSELOKUL_OGRENCI_ISLERI_PERSONELI = __(u"Yüksekokul Öğrenci İşleri Personeli")
