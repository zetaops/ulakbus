...
class RaporIndirForm(JsonForm):
    """
    Proje raporunun öğretim üyesi tarafından indirilmesi işlemini içerir.
...
class BapProjeRaporu(CrudView):
    ...
    def rapor_yukle(self):
        ...
        """
        form = RaporIndirForm(self.object, current=self.current, title="Rapor Yükleme Formu")
        self.form_out(form)
