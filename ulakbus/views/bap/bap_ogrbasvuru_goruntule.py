...
class BasvuruInceleme(CrudView):
    ...
    def butce_plani_goster(self):
        ...
        for plan in BAPButcePlani.objects.filter(ilgili_proje=self.object).order_by():
            ...
            list_item = {
                "fields": [muhasebe_kodu, kod_adi, ad, birim_fiyat, adet, toplam_fiyat,
                           gerekce],
                "actions": "",
            }
    ...
    def proje_calisanlari_goster(self):
        ...
        self.current.output["meta"]["allow_actions"] = False
        self.output['objects'] = [
            [_(u'Ad'), _(u'Soyad'), _(u'Nitelik'), _(u'Çalışmaya Katkısı')]]
    ...
    def is_plani_goster(self):
        ...
        for plan in BAPIsPaketi.objects.filter(proje=self.object).order_by():
            ...
            bit_tarih = plan.bitis_tarihi.strftime(
                DATE_DEFAULT_FORMAT) if plan.bitis_tarihi else ''
    ...
    def universite_disi_uzman_goster(self):
        ...
        self.current.output["meta"]["allow_actions"] = False
        self.output['objects'] = [
            [_(u'Ad'), _(u'Soyad'), _(u'Unvan'), _(u'Kurum'), _(u'Tel'), _(u'Faks'),
             _(u'E-Posta')]]
