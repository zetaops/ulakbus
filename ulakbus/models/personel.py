...
class Personel(Model):
    ...
    tckn = field.String(_(u"TC No"), readonly=True)
    kurum_sicil_no_int = field.Integer(_(u"Kurum Sicil No"), readonly=True)
    ad = field.String(_(u"Adı"), readonly=True)
    soyad = field.String(_(u"Soyadı"), readonly=True)
    cinsiyet = field.Integer(_(u"Cinsiyet"), choices='cinsiyet', readonly=True)
    uyruk = field.String(_(u"Uyruk"), readonly=True)
    ikamet_adresi = field.String(_(u"İkamet Adresi"), readonly=True)
    ikamet_il = field.String(_(u"İkamet İl"), readonly=True)
    ikamet_ilce = field.String(_(u"İkamet İlçe"), readonly=True)
    ...
    baba_adi = field.String(_(u"Ana Adı"), readonly=True)
    ana_adi = field.String(_(u"Baba Adı"), readonly=True)
    dogum_tarihi = field.Date(_(u"Doğum Tarihi"), format="%d.%m.%Y", readonly=True)
    dogum_yeri = field.String(_(u"Doğum Yeri"), readonly=True)
    medeni_hali = field.Integer(_(u"Medeni Hali"), choices="medeni_hali")
    kayitli_oldugu_il = field.String(_(u"İl"), readonly=True)
    kayitli_oldugu_ilce = field.String(_(u"İlçe"), readonly=True)
    kayitli_oldugu_mahalle_koy = field.String(_(u"Mahalle/Köy"), readonly=True)
    kayitli_oldugu_cilt_no = field.String(_(u"Cilt No"), readonly=True)
    kayitli_oldugu_aile_sira_no = field.String(_(u"Aile Sıra No"), readonly=True)
    kayitli_oldugu_sira_no = field.String(_(u"Sıra No"), readonly=True)
    kimlik_cuzdani_verildigi_yer = field.String(_(u"Cüzdanın Verildiği Yer"), readonly=True)
    kimlik_cuzdani_verilis_nedeni = field.String(_(u"Cüzdanın Veriliş Nedeni"), readonly=True)
    kimlik_cuzdani_kayit_no = field.String(_(u"Cüzdan Kayıt No"), readonly=True)
    kimlik_cuzdani_verilis_tarihi = field.String(_(u"Cüzdan Kayıt Tarihi"), readonly=True)
