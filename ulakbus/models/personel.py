...
class Ceza(Model):
    ...
    teklif_edilen_ceza = field.Integer(_(u"Teklif Edilen Ceza"), choices="ceza_turleri",required=False)
    takdir_edilen_ceza = field.Integer(_(u"Takdir Edilen Ceza"), choices="ceza_turleri",required=False)
